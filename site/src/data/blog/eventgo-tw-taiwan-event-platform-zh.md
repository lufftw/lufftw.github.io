...
[**EventGo**](https://eventgo.tw/) 是一個全端活動探索平台。它從全台各大來源聚合活動資訊，讓你用智慧搜尋、互動地圖、日曆檢視，甚至 AI 聊天機器人來找到你想參加的活動。
...
- **列表模式** — 經典搜尋結果，支援類別、城市、日期、價格篩選
- **地圖模式** — Leaflet.js 互動地圖，直覺地看到活動在哪裡
- **日曆模式** — 月曆排版，一眼掌握整週行程

### AI 聊天推薦

EventGo 的 AI 聊天機器人不是通用問答機器人。它直接連接即時活動資料庫，能理解像是「我週末要帶女朋友出去，想找浪漫一點的免費活動，最好在台北」這樣的自然語言。
...
- **4,000+** 場活動已索引並可搜尋
- **76** 個自動發現的主題分類（透過 k-means 分群 + LLM 命名）
- **亞秒級**搜尋回應（快取查詢 < 1ms）
